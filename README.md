...
### Known Bugs
 ...
 - The gap between Titles and sections are a bit oversized, this was how I find a solution to see the Titles below the Nav Bar after I fixed the NavBar to TOP of website.  
...
- __Researches__
  ...
  - I used [W3Shools](https://www.w3schools.com/) and [Devdocs](https://devdocs.io/) to help me with some HTML and CSS informations/Documentation.
  - Also to fix some bugs that I do not found inside documentation I used the Comunity [Stackoverflow](https://stackoverflow.com/) to help me with this bugs.
